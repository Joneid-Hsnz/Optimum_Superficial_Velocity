...
"""
def get_input():
    pr = float(input("Please enter the value for PR:  "))
    ar = float(input("Please enter the value for AR:  "))
    height = int(input("Please enter the value for Height:  "))

    print("\n You successfully entered the values \n")
